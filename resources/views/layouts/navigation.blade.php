<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between sh-16">
            <div class="flex">
                <!-- Logo -->
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('listaroles.index')" :active="request()->routeIs('listaroles.index')">
                    {{ __('Lista roles') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('listapermiso.index')" :active="request()->routeIs('listapermiso.index')">
                    {{ __('Lista permisos') }}
                    </x-nav-link>
                </div>
               @endrole
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <x-responsive-nav-link :href="route('dashboard')">
                ...
                <x-responsive-nav-link :href="route('empleado.index')">
                    {{ __('Employee') }}
                </x-responsive-nav-link>
